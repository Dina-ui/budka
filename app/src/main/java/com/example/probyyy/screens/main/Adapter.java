...
import com.example.probyyy.R;
import com.example.probyyy.model.Note;
import com.example.probyyy.screens.details.NoteDetailsActivity;
...
public class Adapter extends RecyclerView.Adapter <Adapter.NoteViewHolder>{
    ...
    static class  NoteViewHolder extends RecyclerView.ViewHolder{
        ...
        public NoteViewHolder(@NonNull final View itemView) {
            ...
            competed = itemView.findViewById(R.id.completed);
            ...
            competed.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
                @Override
                public void onCheckedChanged(CompoundButton compoundButton, boolean chaked) {
                    if (!silentUpdate){
                        note.done = chaked;
        ...
        public void bind(Note note){
            ...
            silentUpdate = true;
            competed.setChecked(note.done);
            silentUpdate = false;

        }
        private void underStrokeOut(){
            if(note.done){
